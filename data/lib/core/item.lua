...
local aux = {
	...
	['Accuracy'] = {key = ITEM_ATTRIBUTE_ACCURACY},
	['Evasion'] = {key = ITEM_ATTRIBUTE_EVASION},
	['Resolve'] = {key = ITEM_ATTRIBUTE_RESOLVE},
	['Agility'] = {key = ITEM_ATTRIBUTE_AGILITY},
	['Alacrity'] = {key = ITEM_ATTRIBUTE_ALACRITY},
	['Magic'] = {key = ITEM_ATTRIBUTE_MAGIC},
	['Finesse'] = {key = ITEM_ATTRIBUTE_FINESSE},
	['Concentration'] = {key = ITEM_ATTRIBUTE_CONCENTRATION},
	['Focus'] = {key = ITEM_ATTRIBUTE_FOCUS},
	['Distance'] = {key = ITEM_ATTRIBUTE_DISTANCE},
	['Melee'] = {key = ITEM_ATTRIBUTE_MELEE},
	['Shield'] = {key = ITEM_ATTRIBUTE_SHIELD},
	['Concocting'] = {key = ITEM_ATTRIBUTE_CONCOCTING},
	['Enchanting'] = {key = ITEM_ATTRIBUTE_ENCHANTING},
	['Exploring'] = {key = ITEM_ATTRIBUTE_EXPLORING},
	['Smithing'] = {key = ITEM_ATTRIBUTE_SMITHING},
	['Cooking'] = {key = ITEM_ATTRIBUTE_COOKING},
	['Mining'] = {key = ITEM_ATTRIBUTE_MINING},
	['Gathering'] = {key = ITEM_ATTRIBUTE_GATHERING},
	['Slaying'] = {key = ITEM_ATTRIBUTE_SLAYING},
	['Upgrade'] = {key = ITEM_ATTRIBUTE_UPGRADE},
	['Slot1'] = {key = ITEM_ATTRIBUTE_SLOT1},
	['Slot1value'] = {key = ITEM_ATTRIBUTE_SLOT1VALUE},
	['Slot2'] = {key = ITEM_ATTRIBUTE_SLOT2},
	['Slot2value'] = {key = ITEM_ATTRIBUTE_SLOT2VALUE},
	['Slot3'] = {key = ITEM_ATTRIBUTE_SLOT3},
	['Slot3value'] = {key = ITEM_ATTRIBUTE_SLOT3VALUE},
	['Slot4'] = {key = ITEM_ATTRIBUTE_SLOT4},
	['Slot4value'] = {key = ITEM_ATTRIBUTE_SLOT4VALUE},
	['Slot5'] = {key = ITEM_ATTRIBUTE_SLOT5},
	['Slot5value'] = {key = ITEM_ATTRIBUTE_SLOT5VALUE},
	['Criticalhitchance'] = {key = ITEM_ATTRIBUTE_CRITICALHITCHANCE},
	['Criticalhitamount'] = {key = ITEM_ATTRIBUTE_CRITICALHITAMOUNT},
	['MPregen'] = {key = ITEM_ATTRIBUTE_MPREGEN},
	['HPregen'] = {key = ITEM_ATTRIBUTE_HPREGEN},
	['HP'] = {key = ITEM_ATTRIBUTE_HP},
	['MP'] = {key = ITEM_ATTRIBUTE_MP},
