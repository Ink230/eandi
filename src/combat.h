...
/*
	Weird mix mash of combat parameters to account for.
	Notable: Conditions, combatType, origin, blocks, aggressive.
*/
struct CombatParams {
...
/*
	The class that makes battle possible. 
	Others call on combat after setting up parameters and calling combat:: functions.
*/
class Combat
{
	public:
