...
enum AttrTypes_t
{
	...
	ATTR_CRITICALHITCHANCE = 70,
	ATTR_CRITICALHITAMOUNT = 71,
	ATTR_MPREGEN = 72,
	ATTR_HPREGEN = 73,
	ATTR_HP = 74,
	ATTR_MP = 75
...
class Item : virtual public Thing
{
	public:
		...
		int32_t getCRITICALHITAMOUNT() const
		{
			...
			{
				return getIntAttr(ITEM_ATTRIBUTE_CRITICALHITAMOUNT);
			}
			return 0;
		}
		int32_t getMPREGEN() const
		{
			...
			{
				return getIntAttr(ITEM_ATTRIBUTE_MPREGEN);
			}
			return 0;
		}
		int32_t getHPREGEN() const
		{
			...
			{
				return getIntAttr(ITEM_ATTRIBUTE_HPREGEN);
			}
			return 0;
		}
		int32_t getHP() const
		{
			...
			{
				return getIntAttr(ITEM_ATTRIBUTE_HP);
			}
			return 0;
		}
		int32_t getMP() const
		{
			...
			{
				return getIntAttr(ITEM_ATTRIBUTE_MP);
			}
			return 0;
		}
