...
enum ItemParseAttributes_t
{
	...
	ITEM_PARSE_SKILLACCURACY,
	ITEM_PARSE_SKILLEVASION,
	ITEM_PARSE_SKILLARMOUR,
	ITEM_PARSE_SKILLRESOLVE,
	ITEM_PARSE_SKILLAGILITY,
	ITEM_PARSE_SKILLALACRITY,
	ITEM_PARSE_SKILLFINESSE,
	ITEM_PARSE_SKILLCONCENTRATION,
	ITEM_PARSE_SKILLFOCUS,
	ITEM_PARSE_SKILLCONCOCTING,
	ITEM_PARSE_SKILLENCHANTING,
	ITEM_PARSE_SKILLEXPLORING,
