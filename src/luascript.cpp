...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(CONDITION_PARAM_SKILL_ACCURACY)
	registerEnum(CONDITION_PARAM_SKILL_EVASION)
	registerEnum(CONDITION_PARAM_SKILL_ARMOUR)
	registerEnum(CONDITION_PARAM_SKILL_RESOLVE)
	registerEnum(CONDITION_PARAM_SKILL_AGILITY)
	registerEnum(CONDITION_PARAM_SKILL_ALACRITY)
	registerEnum(CONDITION_PARAM_SKILL_FINESSE)
	registerEnum(CONDITION_PARAM_SKILL_CONCENTRATION)
	registerEnum(CONDITION_PARAM_SKILL_FOCUS)
	registerEnum(CONDITION_PARAM_SKILL_CONCOCTING)
	registerEnum(CONDITION_PARAM_SKILL_ENCHANTING)
	registerEnum(CONDITION_PARAM_SKILL_EXPLORING)
	registerEnum(CONDITION_PARAM_SKILL_SMITHING)
	registerEnum(CONDITION_PARAM_SKILL_COOKING)
	registerEnum(CONDITION_PARAM_SKILL_MINING)
	registerEnum(CONDITION_PARAM_SKILL_GATHERING)
	registerEnum(CONDITION_PARAM_SKILL_SLAYING)
	...
	registerEnum(CONDITION_PARAM_SKILL_ACCURACYPERCENT)
	registerEnum(CONDITION_PARAM_SKILL_EVASIONPERCENT)
	registerEnum(CONDITION_PARAM_SKILL_ARMOURPERCENT)
	registerEnum(CONDITION_PARAM_SKILL_RESOLVEPERCENT)
	registerEnum(CONDITION_PARAM_SKILL_AGILITYPERCENT)
	registerEnum(CONDITION_PARAM_SKILL_ALACRITYPERCENT)
	registerEnum(CONDITION_PARAM_SKILL_FINESSEPERCENT)
	registerEnum(CONDITION_PARAM_SKILL_CONCENTRATIONPERCENT)
	registerEnum(CONDITION_PARAM_SKILL_FOCUSPERCENT)
	registerEnum(CONDITION_PARAM_SKILL_CONCOCTINGPERCENT)
	registerEnum(CONDITION_PARAM_SKILL_ENCHANTINGPERCENT)
	registerEnum(CONDITION_PARAM_SKILL_EXPLORINGPERCENT)
	registerEnum(CONDITION_PARAM_SKILL_SMITHINGPERCENT)
	registerEnum(CONDITION_PARAM_SKILL_COOKINGPERCENT)
	registerEnum(CONDITION_PARAM_SKILL_MININGPERCENT)
	registerEnum(CONDITION_PARAM_SKILL_GATHERINGPERCENT)
	registerEnum(CONDITION_PARAM_SKILL_SLAYINGPERCENT)
	...
	registerEnum(SKILL_MAGLEVEL)
	registerEnum(SKILL_LEVEL)
	registerEnum(SKILL_ACCURACY)
	registerEnum(SKILL_EVASION)
	registerEnum(SKILL_ARMOUR)
	registerEnum(SKILL_RESOLVE)
	registerEnum(SKILL_AGILITY)
	registerEnum(SKILL_ALACRITY)
	registerEnum(SKILL_FINESSE)
	registerEnum(SKILL_CONCENTRATION)
	registerEnum(SKILL_FOCUS)
	registerEnum(SKILL_CONCOCTING)
	registerEnum(SKILL_ENCHANTING)
	registerEnum(SKILL_EXPLORING)
	registerEnum(SKILL_SMITHING)
